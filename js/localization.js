(function () {
  ...
  var translations = {
    ...
    en: {
      ...
      pages: {        index: {
          ...
          heroTag: "Yabi Studio",
          heroHeadingHtml: '<span class="homepage-hero__title-line">We build websites,</span><span class="homepage-hero__title-line">that <span class="homepage-hero__bounds homepage-hero__bounds--cyan">work</span></span><span class="homepage-hero__title-line">for <span class="homepage-hero__bounds homepage-hero__bounds--magenta">you!</span></span>',
        ...
        contact: {
          ...
          emailPlaceholder: "jobs@email.com",
  ...
  var pageMappings = {    index: [
      { selector: '.homepage-hero__chip-label', key: 'pages.index.heroTag' },
      { selector: '.homepage-hero__title', key: 'pages.index.heroHeadingHtml', type: 'html' },
      { selector: '.homepage-hero__description', key: 'pages.index.heroDescription' },
      { selector: '.homepage-hero__cta-label', key: 'common.cta.contactUs' },
